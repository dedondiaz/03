...
def test_notion_connect_status_disconnect(client, monkeypatch, login):
...
def test_notion_rls_isolation(client, monkeypatch, login):
    headers = login(client)
...
def test_notion_sync_tool(client, monkeypatch, login):
    headers = login(client)
    _connect_notion(client, headers, monkeypatch)
