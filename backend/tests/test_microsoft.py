...
def test_microsoft_rls_isolation(client, monkeypatch):
...
def test_microsoft_state_validation(client, monkeypatch):
    headers = login(client)
    client.post('/integrations/microsoft/connect', headers=headers)
...
def test_microsoft_refresh_rotating_token_persists(client, monkeypatch):
    headers = login(client)
...
def test_ms_mail_send_risk_gating(client, monkeypatch):
    headers = login(client)
    _connect_ms(client, headers, monkeypatch)
...
def test_ms_calendar_cancel_always_high(client, monkeypatch):
    headers = login(client)
    _connect_ms(client, headers, monkeypatch)
...
def test_ms_calendar_create_idempotency(client, monkeypatch):
    headers = login(client)
    _connect_ms(client, headers, monkeypatch)
